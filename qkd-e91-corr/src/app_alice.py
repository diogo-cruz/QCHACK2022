...
def get_corr(alice_mis_base, alice_mis_res, bob_mis_base, bob_mis_res):
	...
	for i in range(len(alice_mis_base)):
		...
		if alice_mis_base[i]=="(1,4)" and bob_mis_base[i]=="(1,8)":
			if alice_mis_res[i]==1 and bob_mis_res[i]==1:
				...
				Pmpa1b1 += 1
		# a3 b3
		if alice_mis_base[i]=="(0)" and bob_mis_base[i]=="(15,8)":
			if alice_mis_res[i]==1 and bob_mis_res[i]==1:
				Pppa3b3 += 1
			elif alice_mis_res[i]==0 and bob_mis_res[i]==0:
				Pmma3b3 += 1
				...
				Pmpa3b3 += 1
		# a1 b3
		if alice_mis_base[i]=="(1,4)" and bob_mis_base[i]=="(15,8)":
			if alice_mis_res[i]==1 and bob_mis_res[i]==1:
				Pppa1b3 += 1
			elif alice_mis_res[i]==0 and bob_mis_res[i]==0:
				Pmma1b3 += 1
				...
				Pmpa1b3 += 1
		# a3 b1
		if alice_mis_base[i]=="(0)" and bob_mis_base[i]=="(1,8)":
			if alice_mis_res[i]==1 and bob_mis_res[i]==1:
				Pppa3b1 += 1
			elif alice_mis_res[i]==0 and bob_mis_res[i]==0:
				Pmma3b1 += 1
